...
description: A threshold-based cryptographic scheme for secure distributed secret storage
keywords:
  [
    shamir,
    secret sharing,
...
:::info 예제 코드
전체 테스트 코드는 [crypto-examples/cryptography-examples/04-shamir-secret-sharing](https://github.com/chihunmanse/crypto-examples/tree/main/cryptography-examples/04-shamir-secret-sharing)에서 확인할 수 있다.
:::
